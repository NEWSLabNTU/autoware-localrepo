#!/usr/bin/env bash
# Autoware 1.9.0 workspace environment setup
# Usage: source /opt/autoware/1.9.0/setup.bash

export AUTOWARE_VERSION="1.9.0"
export AUTOWARE_HOME="/opt/autoware/1.9.0"
