...
Source: autoware-ros-packages-1-9-0
Section: misc
Priority: optional
...
Package: autoware-ros-packages-1-9-0
Architecture: all
...
EXCLUDE_PACKAGES=(
    "ros-humble-autoware-mission-planner-1-9-0"  # Superseded by autoware_mission_planner_universe
)
