...
DEB_FILE="$BASEDIR/packages/autoware-localrepo-1-7-1_1.7.1-1jetpack62_all.deb"
...
docker build --platform linux/arm64 -t autoware-localrepo-test:1.7.1-jp62 "$TMPDIR"
