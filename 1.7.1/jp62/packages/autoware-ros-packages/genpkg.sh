...
Source: autoware-ros-packages-1-7-1
Section: misc
Priority: optional
...
Package: autoware-ros-packages-1-7-1
Architecture: all
...
EXCLUDE_PACKAGES=(
    "ros-humble-autoware-mission-planner-1-7-1"  # Superseded by autoware_mission_planner_universe
)
